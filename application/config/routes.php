...
$route['questions/sell-trade'] = 'questions/sell_trade';
$route['wallet'] = 'wallet';
...
$route['admin/withdrawals/settings'] = 'admin/withdrawals/settings';
$route['admin/withdrawals/save-settings'] = 'admin/withdrawals/save_settings';
...
$route['admin/questions/completed'] = 'admin/questions/completed';
...
$route['admin/referrals/list-data'] = 'admin/referrals/list_data';
$route['admin/deposits/requests'] = 'admin/deposits/requests_page';
$route['admin/deposits/requests-data'] = 'admin/deposits/requests_data';
